...
const ServicesSection = ({ onTransportClick }: ServicesSectionProps) => {
  ...
  const transportServices = [
    { icon: MapPin, title: t.services.transport.coverage, description: t.services.transport.coverageDesc },
    { icon: Zap, title: t.services.transport.express, description: t.services.transport.expressDesc },
    { icon: Clock, title: t.services.transport.standard, description: t.services.transport.standardDesc },
    { icon: Truck, title: t.services.transport.economic, description: t.services.transport.economicDesc },
  ];
    ...
    <section id="servicos" className="py-20 md:py-32 bg-background" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.2 }} className="glass-card p-8">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.3 }} className="glass-card p-8 border-gold/30">
            <h3 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
            ...
            <Button onClick={onTransportClick} className="w-full bg-gold hover:bg-gold-light text-navy-dark font-bold shadow-lg rounded-xl">
              {t.services.calculateFreight}
